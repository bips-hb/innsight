...
> Since the **innsight** package relies on the **torch** package for each method and this requires a successful installation of LibTorch and other dependencies (`torch::install_torch()`), no examples can be run in the R vignette for memory reasons. For the executed codechunks we refer to [our website](https://bips-hb.github.io/innsight/articles/detailed_overview.html).
...
> **`r knitr::asis_output("\U1F4DD")`  Note**  
> Because of the complexity of 2D inputs, this argument is used only 
