...
[vignette "In-depth Explanation"](https://bips-hb.github.io/innsight/articles/detailed_overview.html) 
...
available (see the [detailed vignette](https://bips-hb.github.io/innsight/articles/detailed_overview.html#package-torch) for details).
...
functions are accepted  (see the [in-depth vignette](https://bips-hb.github.io/innsight/articles/detailed_overview.html#package-keras) for details).
...
`?Gradient` or `?LRP`) or [in-depth vignette](https://bips-hb.github.io/innsight/articles/detailed_overview.html#methods).
...
[here for `boxplot`](https://bips-hb.github.io/innsight/articles/detailed_overview.html#plot-summarized-results-boxplot).
