...
predictions of modern Neural Networks. It implements several model-specific 
interpretability methods based on Neural Networks in R, e.g., 
...
knitr::include_graphics(c("man/images/vgg16_1.png",
                          "man/images/vgg16_2.png",
                          "man/images/vgg16_3.png",
                          "man/images/vgg16_dog.png"))
```
...
Basically, a Neural Network of the libraries [`torch`](https://torch.mlverse.org/), [`keras`](https://keras.rstudio.com/) and [`neuralnet`](https://cran.r-project.org/web/packages/neuralnet/)
...
* `keras::keras_model_sequential` or `keras::keras_model` with layers `layer_dense`, `layer_conv1d`,
`layer_conv2d`, `layer_max_pooling_1d`, `layer_max_pooling_2d`, 
...
```
```{r, fig.width=12, fig.height=8, results='hide', fig.keep='all', message = FALSE, eval = TRUE}
