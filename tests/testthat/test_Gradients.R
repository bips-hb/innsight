...
test_that("Test Gradient method",{
  ...
  expect_error(Gradient(analyzer, iris[1:10,-5], out_class = -1))
  expect_error(Gradient(analyzer, iris[1:10,-5], out_class = "asdf"))
  expect_error(Gradient(analyzer, iris[1:10,-5], out_class = 10))
  ...
  expect_error(Gradient(analyzer, iris[1:10,-5], out_class = 1), NA)
  expect_error(Gradient(analyzer, data = iris[1:10,-5], times_input = FALSE, out_class = 1), NA)

  # test with data.frame
  result <- Gradient(analyzer, iris[1:10,-5], out_class = NULL)
  ...
  result <- Gradient(analyzer, iris[1:10,-5], times_input = FALSE, out_class = NULL)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- Gradient(analyzer, iris[1:10, -5], out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- Gradient(analyzer, iris[1:10, -5], times_input = FALSE, out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))
  ...
  dimnames(d) <- c()
  result <- Gradient(analyzer, d, out_class = NULL)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- Gradient(analyzer, d, out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))
...
test_that("Test SmoothGrad method",{
  ...
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], out_class = -1))
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], out_class = "asdf"))
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], out_class = 10))
  ...
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], out_class = 1), NA)
  expect_error(SmoothGrad(analyzer, data = iris[1:10,-5], times_input = FALSE, out_class = 1), NA)
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], n = 10), NA)
  expect_error(SmoothGrad(analyzer, iris[1:10,-5], noise_level = 2), NA)

  # test with data.frame
  result <- SmoothGrad(analyzer, iris[1:10,-5], out_class = NULL)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- SmoothGrad(analyzer, iris[1:10,-5], times_input = FALSE, out_class = NULL)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- SmoothGrad(analyzer, iris[1:10, -5], out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- SmoothGrad(analyzer, iris[1:10, -5], times_input = FALSE, out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))
  ...
  d <- t(as.matrix(t(iris[1:10,-5])))
  dimnames(d) <- c()
  result <- SmoothGrad(analyzer, d, out_class = NULL)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))

  result <- SmoothGrad(analyzer, d, out_class = 1)
  expect_true("Gradient" %in% class(result))
  expect_true("ggplot" %in% class(plot(result)))
  expect_true("ggplot" %in% class(plot(result, rank = TRUE)))
  expect_true("ggplot" %in% class(plot(result, scale = TRUE)))
